  ...
  <move-aria-current-on-visit class="navigation">
    ...
    [#if hasNoschema]
      <div class="no-schema">
        ...
        <p>Below are components found in content data, but without a matching type in the schema (ie. code from the app).<br/><br/>Could happen as a result of changes in code without updating/converting/deleting references in content yet. Should probably be checked for deprecated data:</p>
